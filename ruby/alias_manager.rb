...
loop do
	...
	if input == 'q'
		...
		aliases.each do |real_name, result|
			puts "#{real_name} is also known as #{result}."
		end
		break
	end
...
def fake_name(real_name, aliases)
	...
	consonants = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z']
		...
		aliases[join_real_name] = result
end

fake_name(["#{first_name}", "#{last_name}"], aliases)
